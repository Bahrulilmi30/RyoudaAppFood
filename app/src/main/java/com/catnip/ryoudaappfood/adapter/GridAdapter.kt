...
import com.catnip.ryoudaappfood.databinding.ItemGridMenuBinding
import com.catnip.ryuodaappfood.model.Item

class GridAdapter(private val item: ArrayList<Item>) :
    RecyclerView.Adapter<GridAdapter.ListViewHolder>() {

    inner class ListViewHolder(val binding: ItemGridMenuBinding) :
